...
public abstract class StatementVisitorBase implements StatementVisitor {
    ...
    public void visit(Select select) {
        unhandledStatement("SELECT");
    }

    public void visit(Delete delete) {
        unhandledStatement("DELETE");
    }

    public void visit(Update update) {
        unhandledStatement("UPDATE");
    }

    public void visit(Insert insert) {
        unhandledStatement("INSERT");
    }

    public void visit(Replace replace) {
        unhandledStatement("REPLACE");
    }

    public void visit(Drop drop) {
        unhandledStatement("DROP");
    }

    public void visit(Truncate truncate) {
        unhandledStatement("TRUNCATE");
    }
